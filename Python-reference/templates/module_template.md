...
file_path: ''           # relative path, e.g. Python-reference/docs/modules/module_name.md
---
...
- **explanation:**  
  Show both basic and typical import patterns.
  if pip required show min 2 of each examples for windows and ios how to install it (i want min 2 bcs sometimes does not work wanna give user more options)
