# Practice Exercise 8 Basic Engineering Mathematics

## 1. $2\frac{1}{2} - \frac{3}{5} \times \frac{20}{27}$
...
&= \frac{1}{3} - \frac{\cancel{3}^{1}}{1} \times \frac{4}{\cancel{27}^{9}} \\[6pt]
...
&= \frac{1}{2} + \frac{\cancel{3}^{1}}{\cancel{5}^{1}} \times \frac{\cancel{15}^{3}}{\cancel{9}^{3}} - \frac{1}{3} \\[6pt]
&= \frac{1}{2} + 1 - \frac{1}{3} \\[6pt]
&= \frac{3}{6} + \frac{6}{6} - \frac{2}{6} \\[6pt]
&= \frac{7}{6} \\[6pt]
&= \boxed{1\frac{1}{6}}
\end{aligned}
$$
...
&= \frac{1}{5} + \frac{8}{\cancel{3}^{1}} \times \frac{\cancel{9}^{3}}{5} - \frac{1}{4} \\[6pt]
&= \frac{1}{5} + \frac{24}{5} - \frac{1}{4} \\[6pt]
&= \frac{25}{5} - \frac{1}{4} = 5 - \frac{1}{4} \\[6pt]
...
&= \frac{\cancel{4}^{2}}{5} \times \frac{1}{\cancel{2}^{1}}
- \frac{1}{6} \times \frac{5}{2} + \frac{2}{3} \\[6pt]
...
&= \frac{3}{5} - \left(\frac{4}{6} - \frac{3}{6}\right)
\div \left(\frac{5}{\cancel{6}^{2}} \times \frac{\cancel{3}^{1}}{2}\right) \\[6pt]
&= \frac{3}{5} - \frac{1}{6} \div \frac{5}{4} \\[6pt]
&= \frac{3}{5} - \frac{1}{6} \times \frac{4}{5} \\[6pt]
&= \frac{3}{5} - \frac{1}{\cancel{6}^{3}} \times \frac{\cancel{4}^{2}}{5} \\[6pt]
&= \frac{3}{5} - \frac{2}{15} \\[6pt]
...
&= \frac{\cancel{20}^{4}}{3} \times \frac{7}{\cancel{5}^{1}} - \frac{1}{3} \\[6pt]
...
&= \frac{27}{4} \times \frac{2}{3} \\[6pt]
&= \frac{\cancel{27}^{9}}{\cancel{4}^{2}}
...
&= \frac{4}{3} \times \frac{11}{5} \times \frac{5}{2} \\[6pt]
&= \frac{\cancel{4}^{2}}{3} \times \frac{11}{\cancel{5}^{1}}
...
&= \frac{2}{3}
+ \frac{\cancel{16}^{8}}{\cancel{5}^{1}}
\times \frac{\cancel{5}^{1}}{\cancel{2}^{1}}
+ \frac{4}{3} \\[6pt]
...
&= \frac{25}{3} \times \frac{3}{10} \\[6pt]
&= \frac{25}{\cancel{3}^{1}}
\times \frac{\cancel{3}^{1}}{10} \\[6pt]
&= \frac{25}{10} \\[6pt]
...
\frac{\cancel{13}^{1}}{10} + \frac{7}{2} - \frac{3}{4} \\[6pt]
&= \frac{1}{10} + \frac{7}{2} - \frac{3}{4} \\[6pt]
&= \frac{2}{20} + \frac{70}{20} - \frac{15}{20} \\[6pt]
&= \frac{57}{20} \\[6pt]
&= \boxed{2\frac{17}{20}}
\end{aligned}
$$
